...
expansion (\cxxref{temp.variadic}), the invented template parameter is a 
template parameter pack (\cxxref{temp.variadic}).
\end{itemize}
% 
...
\defn{equivalent} if constraints associated by their corresponding
