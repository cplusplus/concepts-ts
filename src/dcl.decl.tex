...
(\ref{dcl.fct.default})\added{, constraints associated by an 
optional \grammarterm{requires-clause} (Clause~\ref{temp}),} or
the exception specification (\ref{except.spec}), are part of the function 
type.
\end{quote}
...
\grammarterm{constrained-type-specifier} (\ref{temp.concept.resolve}).
% 
