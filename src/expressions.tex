...
that \grammarterm{nested-name-specifier} designates a placeholder type that 
...
\grammarterm{requires-expression}{s} in the order in which the
\grammarterm{requirement}{s} are written.
