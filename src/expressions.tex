...
introduced by a \grammarterm{nested-requirement} is normalized 
(\ref{temp.constr.decl}) for the purposes of determining constraint
satisfaction (\ref{temp.constr}) and partial ordering (\ref{temp.constr.order}).
\exitnote
