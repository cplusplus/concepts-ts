...
\pnum Two constraints \tcode{P} and \tcode{Q} are equivalent if and
...
\tcode{Q} if and only if they are equivalent constraints.
% 
\enterexample
...
\tcode{Q} if and only if \tcode{P} and \tcode{Q} are equivalent constraints.
