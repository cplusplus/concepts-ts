...
appears
\begin{itemize}
\item as part of a \grammarterm{constrained-type-specifier},
\item in a \grammarterm{constrained-parameter} declaration, or
...
\grammarterm{template-id}{s} in predicate constraints. In that context,
\grammarterm{template-name} that refers to a set of concept definitions is
a \grammarterm{concept-name}.
...
template parameter declared in the template parameter list of \tcode{CC}
