...
\item A \grammarterm{requires-expression} having the form

\begin{ncsimplebnf}
\terminal{requires} requirement-body
\end{ncsimplebnf}
% 
...
\tcode{$\lambda$(T x)} the expression constraint \tcode{++x}, and
% 
those of \#4 are simply the predicate constraint \tcode{(bool)3 + 4}.
% 
