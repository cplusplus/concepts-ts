...
\item the \grammarterm{constraint-expression} introduced by each
      \grammarterm{constrained-parameter}{s} (\ref{temp.param}) in the 
...
estblishes the order in which the normalized constraints (defined below) 
...
\pnum
Determining the satisfaction of a declration's associated constraints,
and the the partial ordering of declarations by those constraints,
