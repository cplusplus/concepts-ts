...
initializers, if any\added{, but not their \grammarterm{requires-clause}{s}}).
...
\setcounter{Paras}{15}
\pnum
The \grammarterm{requires-clause} of a template specialization or member function is not
instantiated along with the specialization or function itself, even for a member
function of a local class;
substitution into the the atomic constraints within it is instead performed
