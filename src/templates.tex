...
\end{codeblock}
The error in \tcode{S4} is caused by the substitution of \tcode{int} into 
the associated constraints of the template parameter \tcode{X}.
% 
In the \tcode{S5}, there are no constraints can be checked for the 
type \tcode{typename Y::template MT<char>} because \tcode{MT} is a member
