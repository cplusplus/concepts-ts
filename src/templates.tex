...
\item Then, form an \grammarterm{id-expression} \tcode{E} as 
\tcode{C<A1, ..., A$N$>}.
\end{itemize}
% 
\tcode{E} is the introduced \grammarterm{constraint-expression}.
...
C1{T} void f(T, auto); // same semantics as \tcode{template<C1 T, typename U> void f(T, U);}
\end{codeblock}
% 
\exitexample
\end{addedblock}
...
void f1() requires C1<void>;   // friend of all \tcode{S<T>}
