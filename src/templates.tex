...
\nontermdef{constrained-parameter}\br
  qualified-concept-name ...\opt identifier\opt default-template-argument\opt\br
...
\item If the \grammarterm{qualified-concept-name} is follwed by an ellipsis,
...
% 
The constraint is derived from the \grammarterm{constrained-type-name} 
\tcode{CC} in the \grammarterm{constrained-parameter}, its designated concept 
...
a constrained non-function template or a constrained template template parameter,
...
associated constraints of the constrained template shall be satisfied.
(\ref{temp.constr}). 
% 
\enterexample
\begin{codeblock}
