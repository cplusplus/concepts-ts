...
constraints (Clause~\ref{temp}). This allows different translation units
...
namespace (if any)\added{, and any associated constraints~(Clause~\ref{temp})}\\
...
parameter list\added{, and any associated constraints~(Clause~\ref{temp})}
\end{quote}
